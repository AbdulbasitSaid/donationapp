...
class RecentDoneesResponseModel {
  ...
  factory RecentDoneesResponseModel.fromMap(Map<String, dynamic> map) {
    return RecentDoneesResponseModel(
      status: map['status'] ?? '',
      message: map['message'] ?? '',
      data: List<RecentDoneeData>.from(
          map['data']?.map((x) => RecentDoneeData.fromMap(x))),
    );
  }
...
class RecentDoneeData {
  ...
  factory RecentDoneeData.fromMap(Map<String, dynamic> map) {
    return RecentDoneeData(
      id: map['id'] ?? '',
  ...
  factory RecentDoneeData.fromJson(String source) =>
      RecentDoneeData.fromMap(json.decode(source));
}
