...
class AuthenticationRepository {
  ...
  Future<Either<AppError, UserModel>> registerUser(
  ...
  Future<Either<AppError, String>> resendOtpCode() async {
    try {
      final response = await _authenticationRemoteDataSource.resendOptCode();
  ...
  Future<Either<AppError, String>> changePassword(
    ...
    try {
      final newPasswordData =
          await _authenticationLocalDataSource.getSaveResetPasswordAndToken();
      final response =
          await _authenticationRemoteDataSource.changePassword(params: {
        "email": newPasswordData.email,
        "password": newPassword,
        "password_reset_token": newPasswordData.passwordResetToken
      });
