...
class DonationHistorySearchListCardItem extends StatelessWidget {
  final DonationHistoryDatumModel donationData;
  final String highlightString;
  const DonationHistorySearchListCardItem(
      {Key? key, required this.donationData, required this.highlightString})
      : super(key: key);
...
class DonationHistoryByIdListCardItem extends StatelessWidget {
  final DonationHistoryDatumModel donationData;

  final Key firstThisMonthKey;
  final Key earlierMonthKey;
  const DonationHistoryByIdListCardItem({
    Key? key,
    required this.donationData,
    required this.earlierMonthKey,
    required this.firstThisMonthKey,
